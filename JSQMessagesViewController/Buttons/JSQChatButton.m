...
//  JSQMessages
//
//  Created by Luke McDonald on 11/9/15.
...
@interface JSQChatButton ()

@property (nonatomic) JSQChatButtonStyle buttonStyle;
...
- (void)commonInitializer {
    ...
    self.shapeLayers = @[self.circleLayer, self.line1Layer, self.line2Layer, self.line3Layer];
    
    self.options = [JSQChatButton defaultOptions];
    ...
    // also, make the button half the bounds in order to increase hit target
    self.dimension = MIN(CGRectGetWidth(self.frame) / 2.0, CGRectGetHeight(self.frame) / 2.0);
...
- (id)valueForOptionKey:(NSString *)key {
    ...
    return [JSQChatButton defaultOptions][key];
}
...
-(void)setStyle:(JSQChatButtonStyle)style
    ...
    if (style == JSQChatButtonStyleHamburger) {
    ...
    } else if (style == JSQChatButtonStylePlus) {
        newCirclePath = [self createCenteredCircleWithRadius:self.dimension/20.0f];
        newCircleAlpha = 0.0f;
    ...
    } else if (style == JSQChatButtonStyleCirclePlus) {
    ...
    } else if (style == JSQChatButtonStyleClose) {
        newCirclePath = [self createCenteredCircleWithRadius:self.dimension/20.0f];
        newCircleAlpha = 0.0f;
        newLine1Path = [self createCenteredLineWithRadius:self.dimension/20.0f angle:0 offset:CGPointMake(0, 0)];
        newLine1Alpha = 0.0f;
    ...
    } else if (style == JSQChatButtonStyleCircleClose) {
        newCirclePath = [self createCenteredCircleWithRadius:self.dimension/2.0f];
        newCircleAlpha = 1.0f;
        newLine1Path = [self createCenteredLineWithRadius:self.dimension/20.0f angle:0 offset:CGPointMake(0, 0)];
        newLine1Alpha = 0.0f;
    ...
    } else if (style == JSQChatButtonStyleCircleCaretLeft) {
        newCirclePath = [self createCenteredCircleWithRadius:self.dimension/2.0f];
        newCircleAlpha = 1.0f;
        newLine1Path = [self createCenteredLineWithRadius:self.dimension/20.0f angle:0 offset:CGPointMake(0, 0)];
        newLine1Alpha = 0.0f;
        newLine2Path = [self createCenteredLineWithRadius:self.dimension/4.6f - self.line2Layer.lineWidth/2.0f angle:-3*M_PI_4 offset:CGPointMake(-2.0f,self.dimension/8.0f)];
        newLine3Path = [self createCenteredLineWithRadius:self.dimension/4.6f - self.line3Layer.lineWidth/2.0f angle:3*M_PI_4 offset:CGPointMake(-2.0f,-self.dimension/8.0f)];
        
    } else if (style == JSQChatButtonStyleCircleCaretRight) {
        newCirclePath = [self createCenteredCircleWithRadius:self.dimension/2.0f];
        newCircleAlpha = 1.0f;
        newLine1Path = [self createCenteredLineWithRadius:self.dimension/20.0f angle:0 offset:CGPointMake(0, 0)];
        newLine1Alpha = 0.0f;
        newLine2Path = [self createCenteredLineWithRadius:self.dimension/4.6f - self.line2Layer.lineWidth/2.0f angle:-M_PI_4 offset:CGPointMake(0.0f,self.dimension/8.0f)];
        newLine3Path = [self createCenteredLineWithRadius:self.dimension/4.6f - self.line3Layer.lineWidth/2.0f angle:M_PI_4 offset:CGPointMake(0.0f,-self.dimension/8.0f)];
        
    } else if (style == JSQChatButtonStyleCaretUp) {
        newCirclePath = [self createCenteredCircleWithRadius:self.dimension/20.0f];
        newCircleAlpha = 0.0f;
        newLine1Path = [self createCenteredLineWithRadius:self.dimension/20.0f angle:0 offset:CGPointMake(0, 0)];
        newLine1Alpha = 0.0f;
    ...
    } else if (style == JSQChatButtonStyleCaretDown) {
        newCirclePath = [self createCenteredCircleWithRadius:self.dimension/20.0f];
        newCircleAlpha = 0.0f;
        newLine1Path = [self createCenteredLineWithRadius:self.dimension/20.0f angle:0 offset:CGPointMake(0, 0)];
        newLine1Alpha = 0.0f;
    ...
    } else if (style == JSQChatButtonStyleCaretLeft) {
        newCirclePath = [self createCenteredCircleWithRadius:self.dimension/20.0f];
        newCircleAlpha = 0.0f;
        newLine1Path = [self createCenteredLineWithRadius:self.dimension/20.0f angle:0 offset:CGPointMake(0, 0)];
        newLine1Alpha = 0.0f;
    ...
    } else if (style == JSQChatButtonStyleCaretRight) {
        newCirclePath = [self createCenteredCircleWithRadius:self.dimension/20.0f];
        newCircleAlpha = 1.0f;
        newLine1Path = [self createCenteredLineWithRadius:self.dimension/20.0f angle:0 offset:CGPointMake(0, 0)];
        newLine1Alpha = 0.0f;
    ...
    } else if (style == JSQChatButtonStyleArrowLeft) {
        newCirclePath = [self createCenteredCircleWithRadius:self.dimension/20.0f];
        newCircleAlpha = 0.0f;
    ...
    } else if (style == JSQChatButtonStyleArrowRight) {
        newCirclePath = [self createCenteredCircleWithRadius:self.dimension/20.0f];
        newCircleAlpha = 0.0f;
        newLine1Path = [self createCenteredLineWithRadius:self.dimension/2.0f angle:0 offset:CGPointMake(0, 0)];
        newLine1Alpha = 1.0f;
...
- (void)setCircleColor:(UIColor *)circleColor animated:(BOOL)animated {
    ...
    if (animated) {
        ...
        fillColorAnimation.fromValue = (id)self.circleLayer.fillColor;
        fillColorAnimation.toValue = (id)[circleColor CGColor];
