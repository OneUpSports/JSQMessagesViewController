...
extern NSString *const kOUSChatButtonHighlightScale;
// the button CGPaths stroke width, default 1.0f pixel
extern NSString *const kOUSChatButtonLineWidth;
// the button CGPaths stroke color, default is black
extern NSString *const kOUSChatButtonColor;
// the button CGPaths stroke color when highlighted, default is light gray
extern NSString *const kOUSChatButtonHighlightedColor;
// duration in second of the highlight (pressed down) animation, default 0.1
extern NSString *const kOUSChatButtonHighlightAnimationDuration;
// duration in second of the unhighlight (button release) animation, defualt 0.15
extern NSString *const kOUSChatButtonUnHighlightAnimationDuration;
// duration in second of the style change animation, default 0.3
extern NSString *const kOUSChatButtonStyleChangeAnimationDuration;
