...
- (void)jsq_configureMessageCellLayoutAttributes:(JSQMessagesCollectionViewLayoutAttributes *)layoutAttributes
{
    ...
    layoutAttributes.messageBubbleBottomLabelHeight = [self.collectionView.delegate collectionView:self.collectionView
                                                                                            layout:self
                                                      heightForMessageBubbleBottomLabelAtIndexPath:indexPath];
    
    /* Cell Accessory Views */
    layoutAttributes.bottomAccessoryViewHeight = [self.collectionView.delegate collectionView:self.collectionView
                                                                                       layout:self
                                                      heightForBottomAccessoryViewAtIndexPath:indexPath];
    
    /* Cell Subview Spacing */
    layoutAttributes.bottomLabelsSpacerHeight = [self.collectionView.delegate collectionView:self.collectionView
                                                                                      layout:self
    ...
    layoutAttributes.messageBubbleAvatarSpacing = [self.collectionView.delegate collectionView:self.collectionView
                                                                                        layout:self spacingBetweenMessageBubbleAndAvatarOfCellAtIndexPath:indexPath];
    ...
    layoutAttributes.bottomLabelRightSpacer = [self.collectionView.delegate collectionView:self.collectionView
                                                                                    layout:self spacingForRightOfCellBottomLabelAtIndexPath:indexPath];
